...
df['condition'] = df['nr4'].shift(2) & df['inside_day'].shift(2)

df['ret'] = np.where(df['condition']&(df['open']>df['high'].shift(2)), df['open']/df['close'].shift(-p[0]),1)
